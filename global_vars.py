...
def dir_name_fn(args, verbose=False):
...
def init(verbose=False):
    ...
    parser.add_argument("--dp", action='store_true', help='train local models with differential privacy technique on all the clients.')
    parser.add_argument("--dp_mul", type=float, default=1e-6,
                        help='noise multiplier for differential privacy.')
    parser.add_argument("--mia", action='store_true', help='use membership inference attack to test the effectiveness of dp')
